...
const kubeResourcePath = "https://raw.githubusercontent.com/liqotech/microservices-demo/master/release/fixed-3clusters-manifests.yaml"
	...
	Describe("Assert that Liqo is up, pod offloading and network connectivity are working", func() {
		Context("Check Join Status", func() {
			...
			DescribeTable("Liqo Virtual Nodes are ready",
				...
				Entry("VirtualNodes are Ready on cluster 1", testContext.Clusters[0], namespace),
				Entry("VirtualNodes are Ready on cluster 2", testContext.Clusters[1], namespace),
				Entry("VirtualNodes are Ready on cluster 3", testContext.Clusters[2], namespace),
			)
			...
			DescribeTable("Liqo Pod to Pod Connectivity Check",
				...
				Entry("Check Pod to Pod connectivity from cluster 1 to cluster 2", testContext.Clusters[0], testContext.Clusters[1], namespace),
				Entry("Check Pod to Pod connectivity from cluster 1 to cluster 3", testContext.Clusters[0], testContext.Clusters[2], namespace),
				Entry("Check Pod to Pod connectivity from cluster 2 to cluster 1", testContext.Clusters[1], testContext.Clusters[0], namespace),
				Entry("Check Pod to Pod connectivity from cluster 2 to cluster 3", testContext.Clusters[1], testContext.Clusters[2], namespace),
				Entry("Check Pod to Pod connectivity from cluster 3 to cluster 1", testContext.Clusters[2], testContext.Clusters[0], namespace),
				Entry("Check Pod to Pod connectivity from cluster 3 to cluster 2", testContext.Clusters[2], testContext.Clusters[1], namespace),
			)
		})
